...
export function Dashboard({productName, productVersion, toggleDrawer, open}: {productName: string | undefined, productVersion: string | undefined, toggleDrawer: () => void, open: boolean }) {
  return (
    ...
    <Box id="dashboard" sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar />
        <Container maxWidth="xl" sx={{ mt: 4, mb: 4, ml: 2, mr: 1}} >
          <Grid container spacing={12}>
            <Grid item xs={4}>
              <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                <ListExistingDiagramsContainer />
              </Paper>
            </Grid>
            <Grid item xs={8}>
              <Paper
          ...
          <Copyright sx={{ pt: 4 }} productname={productName} productversion={productVersion}/>
        </Container>
      </Box>
      <Toastify />
    </Box>
